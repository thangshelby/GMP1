...
const OverviewMarketChartContainer = () => {
  ...
  if (result.isSuccess) {
    return (
      <div className="flex w-full flex-row justify-between gap-x-4 py-4">
        <OverviewMarketChart
  ...
  if (result.isLoading) {
    return (
      <div className="flex w-full flex-row justify-between gap-x-4 p-4">
        <div className="border-secondary-3 flex w-full flex-col rounded-lg border p-2">
